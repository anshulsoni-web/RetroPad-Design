...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--tolerance-mm3", type=float, default=TOLERANCE_MM3, metavar="T",
                   help=f"Volume diff tolerance in mm³ (default: {TOLERANCE_MM3}).")
...
def main() -> int:
    ...
    global TOLERANCE_MM3, TOLERANCE_PCT
